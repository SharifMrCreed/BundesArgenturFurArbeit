...
class Angebot(BaseModel):
    ...
    zugang: Optional[str]
    anrechnung: Optional[Any] = None
    berechtigungen: Optional[Any] = None
    ...
    zertifizierer: Optional[Any] = None
...
companies: List[TrainingsProvider] = list(map(lambda item: item.angebot.bildungsanbieter, root_model.embedded["termine"]))
